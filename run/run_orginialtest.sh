...
pssh -h remotehostshulk.txt -l root -A -i "sshpass -p 'nannan' scp /var/lib/docker/containers/*/*-json.log   root@amaranth2:/home/nannan/testing/resultslogs/20190619_150000"
