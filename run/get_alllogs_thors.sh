...
pssh -h remotehostthors.txt -l root -A -t 400 -i "sshpass -p 'nannan' scp /var/lib/docker/containers/*/*-json.log   root@amaranth$1:/home/nannan/testing/resultslogs/$dir"
