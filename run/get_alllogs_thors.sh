...
sshpass -p 'kevin123' pssh -h remotehostthors.txt -l root -A -t 600 -i "sshpass -p 'nannan' scp /var/lib/docker/containers/*/*-json.log   nannan@amaranth$1:/home/nannan/testing/resultslogs/$dir"
