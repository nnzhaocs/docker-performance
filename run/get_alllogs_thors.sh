...
mkdir -p /home/nannan/testing/resultslogs/$dir
# replace 20190618_164013 with the newly created dir
sshpass -p 'kevin123' pssh -h dedupregistries.txt -l root -A -t 600 -i "sshpass -p 'nannan' scp /var/lib/docker/containers/*/*-json.log   nannan@amaranth$1:/home/nannan/testing/resultslogs/$dir"
