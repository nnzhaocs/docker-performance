...
python create_yaml.py -r $1 -t $2 -m $3 -s $4 -a $5 -n $6 -c $7 -p $8
...
if [ $3 == "restore" ]; then
	...
	./run_sifttest.sh  nnzhaocs/distribution:9nodepreconstruct dedupregistries.txt $cachesize $repullthres
