...
#./create_run_30min.sh 50mb dal sift standard 12 7 4  2 &> resultsdal-b-mode-2.log
echo "test s-mode"
...
#./create_run_30min.sh 50mb dal restore standard 12 14 4 2 &> resultsdal-restore-14.log
